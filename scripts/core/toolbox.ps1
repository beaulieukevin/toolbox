...
[System.Environment]::SetEnvironmentVariable("TOOLBOX_HOME", $($toolboxRootResolved.Path), "Process")
[System.Environment]::SetEnvironmentVariable("TOOLBOX_APPS", "$($toolboxRootResolved.Path)\local\apps", "Process")
